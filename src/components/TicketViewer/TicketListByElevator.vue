      ...
      <template v-for="(group, name, i) in groupMap">
        <b-card :key="i" no-body class="mb-1">
          <b-card-header header-tag="header" class="p-1 text-left">
            {{name}}
            <b-link v-if="i == 2" class="float-right" v-b-tooltip.hover title="View Contract">
              <b-icon-minecart-loaded/> 100% fulfilled
            </b-link>
          </b-card-header>
          <b-card-body>
              ...
              <b-card img-left :img-src="img.pathLong" align="right">
                <b-card-text>
                  <b-row cols="1" cols-md="3">
                    ...
                    <b-col>
                      <b-badge class='mr-1' variant="danger" v-if="i%2 == 1">
                        Not Processed
                      </b-badge>
                      <b-badge variant="success" v-if="i % 3 == 0 && !name.includes('Bunge')">
                        Paid
                      </b-badge>
                    </b-col>
                  </b-row>
